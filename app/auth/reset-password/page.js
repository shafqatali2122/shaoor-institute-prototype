        ...
        <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-gray-100">
            <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-xl border border-gray-200">
                <div className="text-center mb-8">
                    <Link href="/">
                        {/* Use Image component */}
                        <Image src="/shaoor_logo.png" alt="Shaoor Institute Logo" width={80} height={80} className="mx-auto mb-2" />
                    </Link>
                ...
                {/* Reset Form */}
                <form className="space-y-4"> <div> <label htmlFor="reset-email" className="input-label">Email Address</label> <input type="email" id="reset-email" className="input-field" required /> </div> <button type="submit" className="button-primary w-full">Send Reset Link</button> </form>
                {/* Back to Login */}
                <div className="mt-6 text-center text-sm"> <p className="text-gray-600"> Remember your password?{' '} <Link href="/auth" className="font-semibold text-blue-600 hover:underline"> Login </Link> </p> </div>
            </div>
            {/* Helper CSS */}
