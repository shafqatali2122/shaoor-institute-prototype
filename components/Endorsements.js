    ...
    <section className="w-full max-w-7xl py-16">
      ...
      <div className="grid grid-cols-1 md-grid-cols-2 lg-grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 text-center">
          <Image src="/scholar_4.avif" alt="Scholar" width={100} height={100} className="rounded-full mx-auto mb-4 border-4 border-gray-200 object-cover" />
          {/* 2. FIX: Replaced " with &quot; */}
        ...
        {/* Scholar 2 */}
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 text-center">
          <Image src="/scholar_3.avif" alt="Scholar" width={100} height={100} className="rounded-full mx-auto mb-4 border-4 border-gray-200 object-cover" />
        ...
        {/* Scholar 3 */}
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 text-center">
          <Image src="/scholar_2.avif" alt="Scholar" width={100} height={100} className="rounded-full mx-auto mb-4 border-4 border-gray-200 object-cover" />
